...
import com.workbei.exception.HttpAuthException;
...
public class GlobalControllerExceptionHandler {
    ...
    @ExceptionHandler({HttpResultException.class, HttpAuthException.class})
    public ResponseEntity handleHttpResultException(HttpResultException exception) {
        try {
            bizLogger.warn(ExceptionCode.getMessage(APP_REQUEST_PARAM_ERROR, exception.getHttpResultCode()));
